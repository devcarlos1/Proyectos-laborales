<?php
$config = array();
$config['name'] = "agendar_cita_viajes"; //Nombre del directorio donde se aloja la plantilla
$config['full_name'] = "agendar_cita_viajes"; //Nombre completo que aparecerá en la lista
