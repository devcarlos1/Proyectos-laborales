<?php
$config = array();
$config['name'] = "whatsapp_viajes"; //Nombre del directorio donde se aloja la plantilla
$config['full_name'] = "whatsapp_viajes"; //Nombre completo que aparecerá en la lista
