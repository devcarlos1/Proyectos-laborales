<?php
$config = array();
$config['name'] = "pagina-malena"; //Nombre del directorio donde se aloja la plantilla
$config['full_name'] = "landing-nutricion"; //Nombre completo que aparecerá en la lista
