<?php
$config = array();
$config['name'] = "gracias-youtube"; //Nombre del directorio donde se aloja la plantilla
$config['full_name'] = "gracias-youtube"; //Nombre completo que aparecerá en la lista
