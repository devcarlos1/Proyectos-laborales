<?php
$config = array();
$config['name'] = "20-dias_nutricion"; //Nombre del directorio donde se aloja la plantilla
$config['full_name'] = "20-dias_nutricion"; //Nombre completo que aparecerá en la lista
