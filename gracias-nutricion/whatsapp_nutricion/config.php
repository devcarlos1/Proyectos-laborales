<?php
$config = array();
$config['name'] = "whatsapp_nutricion"; //Nombre del directorio donde se aloja la plantilla
$config['full_name'] = "whatsapp_nutricion"; //Nombre completo que aparecerá en la lista
