<?php
$config = array();
$config['name'] = "youtube_nutricion"; //Nombre del directorio donde se aloja la plantilla
$config['full_name'] = "youtube_nutricion"; //Nombre completo que aparecerá en la lista
